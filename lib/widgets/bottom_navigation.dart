...
class BottomNavigationShare extends StatefulWidget {
  @override
  _BottomNavigationShareState createState() => _BottomNavigationShareState();
}

class _BottomNavigationShareState extends State<BottomNavigationShare> {
